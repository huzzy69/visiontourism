...
export const EnglandScotlandTour: React.FC = () => {
  const tour = tours.find((t) => t.id === 'england-scotland-4-days');
  ...
  const inclusions = [
    ...
    'Loch Ness boat cruise & entry ticket voucher',
    'Door-to-door passenger pickup from central London hotels'
  ];
  ...
  return (
    <div className="pt-20 pb-16">
      <PageHeader
        title={tour.title}
        subtitle="The ultimate cross-border private group tour. Witness medieval castles, rolling countryside, and wild Scottish peaks."
        bgImageUrl={tour.imageUrl}
        breadcrumbs={[{ name: 'England to Scotland Tour' }]}
      />
          ...
          <div className="lg:col-span-1">
            <div className="bg-brand-green-900 text-white p-6 sm:p-8 rounded-sm shadow-xl sticky top-28 border border-brand-gold-400/20">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Link
                  to="/contact?inquiry=england-scotland-4-days"
